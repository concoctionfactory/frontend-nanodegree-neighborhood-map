...
var yelp = function () {
  var YELP_TOKEN =
    "YlMcv9vPSHaFuf7Nhx_ehTogP9kgChamwjXtk5h-gDY63vZt-RvcU1AwgI2KB3b41N6psdR840cAxPPlTtB89iWELNVhJsLElP6XJVT4ymxMgnKiavFc6HQRITpOWnYx";
  var yelp_url = "http://api.yelp.com/v3/businesses/search";
  // var cors_anywhere_url = "https://cors-anywhere.herokuapp.com/";
  var cors_anywhere_url = "https://cors.bridged.cc/";
...
var Place = function (data) {
  ...
  var address_1 = data.location.display_address[0]
    ? data.location.display_address[0] + " "
    : "";
  var address_2 = data.location.display_address[1]
      ...
      geocoder.geocode({ address: item.address() }, function (results, status) {
        if (status === google.maps.GeocoderStatus.OK) {
          ...
          self.createMarker(
            results[0],
            item,
            self.checkShowMarker(item, filterPlaces)
          );
        } else {
          alert(
